...
contract Deploy is Script {
    function run() public {
        ...
        console2.log("Deploying ElitraVaultV2 implementation...");
        ElitraVaultV2 implementation = new ElitraVaultV2();
        console2.log("ElitraVaultV2 implementation:", address(implementation));

        // 3. Deploy proxy
        string memory name = "Elitra USDC Vault V2";
        string memory symbol = "eUSDC-v2";
        ...
        console2.log("Proxy (ElitraVaultV2):", address(proxy));
        ...
        console2.log("HybridRedemptionStrategy:", address(redemptionStrategy));
        console2.log("ElitraVaultV2 implementation:", address(implementation));
        console2.log("ElitraVaultV2 proxy:", address(proxy));
    }
