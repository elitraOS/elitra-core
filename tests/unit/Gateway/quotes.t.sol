...
contract Quotes_Test is Gateway_Base_Test {
    ...
    function test_quoteConvertToShares_Success() public view {
        uint256 expectedShares = elitraVault.convertToShares(ASSETS);
        uint256 actualShares = gateway.quoteConvertToShares(address(elitraVault), ASSETS);
    ...
    function test_quoteConvertToAssets_Success() public view {
        uint256 expectedAssets = elitraVault.convertToAssets(SHARES);
        uint256 actualAssets = gateway.quoteConvertToAssets(address(elitraVault), SHARES);
    ...
    function test_quotePreviewDeposit_Success() public view {
        uint256 expectedShares = elitraVault.previewDeposit(ASSETS);
        uint256 actualShares = gateway.quotePreviewDeposit(address(elitraVault), ASSETS);
    ...
    function test_quotePreviewRedeem_Success() public view {
        uint256 expectedAssets = elitraVault.previewRedeem(SHARES);
        uint256 actualAssets = gateway.quotePreviewRedeem(address(elitraVault), SHARES);
    ...
    function test_quoteFunctions_WithZeroValues() public view {
        ...
        uint256 sharesForZeroAssets = gateway.quoteConvertToShares(address(elitraVault), 0);
        uint256 assetsForZeroShares = gateway.quoteConvertToAssets(address(elitraVault), 0);
        uint256 previewSharesForZeroAssets = gateway.quotePreviewDeposit(address(elitraVault), 0);
        uint256 previewAssetsForZeroShares = gateway.quotePreviewRedeem(address(elitraVault), 0);
